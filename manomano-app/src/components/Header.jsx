    ...
    <header className="header">
      ...
      <div className="header-second-level">
        ...
        <div className="search">
          <input type="text" placeholder="look for a product or..." />
          <i>
